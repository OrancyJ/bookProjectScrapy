...
langxie_url = 'https://movie.douban.com/subject/26322642/comments?start=23&limit=20&sort=new_score&status=P&percent_type='
...
if __name__ == '__main__':
    ...
    while (next_page != []):  #查看“下一页”的A标签链接
        ...
        soup = BeautifulSoup(html, 'lxml')
        comment_list, next_page,date_nodes = get_data(html)
        with open("hugelianchang.txt", 'a', encoding='utf-8')as f:
